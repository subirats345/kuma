...
![A Japanese black bear holding a quiet PDF page](../Assets/kuma-mascot.png)
...
## Notes for a quiet page

- Long paragraphs should breathe without feeling loose.
- Images should sit in the flow, scaled to the printable column.
- A small caption should be enough; the page should not become a slide.
